...
# clone_selected.sh
# Clone a curated list of security tools from GitHub and other sources.
...
mkdir -p selected_repos
cd selected_repos

for url in "${REPOS[@]}"; do
  # Only use git clone for GitHub repos, wget/curl for others
  if [[ "$url" =~ ^https://github\.com/.+ ]]; then
    ...
    # Download page or non-GitHub resource
    echo "Non-GitHub URL: $url"
    # Uncomment below to attempt download (if desired), or handle manually
    # wget "$url"
  fi
done

echo "Done cloning selected repositories."